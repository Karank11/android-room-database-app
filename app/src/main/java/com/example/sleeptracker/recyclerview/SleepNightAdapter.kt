...
class SleepNightAdapter: RecyclerView.Adapter<SleepNightAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.qualityString.text = convertNumericQualityToString(item.sleepQuality, resources)
        holder.sleepLength.text = convertDurationToFormatted(item.startTimeInMillis, item.endTimeInMillis, resources)
